...
struct CourseSectionDetailScreen: View {
        ...
        ZStack (alignment: .topTrailing) {
            ScrollView {
                ...
                VStack (alignment: .leading, spacing: 30) {
                    ...
                    Text("Developing for iOS 14 requires a Mac with Catalina and Xcode 12. It is recommended that you upgrade to Big Sur in order to build for macOS using SwiftUI. You can still follow the iOS parts, which is the main focus of this cours"
                    )
                }
                .padding()
            }
...
struct CoursesSectionDetailScreen_Previews: PreviewProvider {
